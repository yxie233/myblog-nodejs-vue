      ...
      <div align="left" class="comments">
        ...
        <div v-if="comments.length>0">
            ...
            <div v-for="item in comments">
              <table class="table">
                <br>
                <font color="#4682B4"><b>{{item.username}}</b></font>:&nbsp;{{item.content}}    
